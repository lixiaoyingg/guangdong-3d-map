...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function uc(e,t,n){let r=new Float32Array(Xs),i=new K(0,1,0);return new Co({name:`SphericalGaussianBlur`,defines:{n:Xs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:pc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function dc(){return new Co({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:pc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fc(){return new Co({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:pc(),fragmentShader:`
	...
	`}var mc=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ui(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var zl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Bl(e,t){let n=zl[t];return n===void 0?(V(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Vl=new K;function Hl(){return J.getLuminanceCoefficients(Vl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Vl.x.toFixed(4)}, ${Vl.y.toFixed(4)}, ${Vl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Nd.BlurDirectionX=new G(1,0),Nd.BlurDirectionY=new G(0,1);function Pd(e){let t=1/0,n=-1/0,r=1/0,i=-1/0;e.features.forEach(e=>{if(!e||!e.geometry)return;let{coordinates:a,type:o}=e.geometry;a&&(o===`MultiPolygon`?a:[a]).forEach(e=>{e.forEach(e=>{e.forEach(([e,a])=>{t=Math.min(t,e),n=Math.max(n,e),r=Math.min(r,a),i=Math.max(i,a)})})})});let a=[(t+n)/2,(r+i)/2],o=n-t,s=i-r;return{center:a,scale:10/Math.max(o,s)}}function Fd(e,t,n){let r=new Ta;return e.forEach(([e,i],a)=>{let o=(e-t[0])*n,s=(i-t[1])*n;a===0?r.moveTo(o,s):r.lineTo(o,s)}),r}var Id=.35;function Ld(e,t){let{center:r,scale:i}=Pd(e),a=new wn,o=new wn,s=new wn,c=new qo().load(`./wenli.jpg`);c.wrapS=n,c.wrapT=n;let l=new Co({uniforms:{wenliMap:{value:c},opacity:{value:0},uHover:{value:0}},vertexShader:`
    ...
    `,transparent:!0,side:2,depthWrite:!0}),u=new Co({uniforms:{bottomColor:{value:new Y(26316)},topColor:{value:new Y(330258)},opacity:{value:0},extrudeDepth:{value:Id},uHover:{value:0}},vertexShader:`
    ...
    `,transparent:!0,side:2,depthWrite:!0});return e.features.forEach(e=>{if(!e||!e.geometry)return;let{coordinates:t,type:n}=e.geometry;t&&(n===`MultiPolygon`?t:[t]).forEach(t=>{if(t[0].length<4)return;let n=Fd(t[0],r,i);for(let e=1;e<t.length;e++)if(t[e].length>=4){let a=new wa;t[e].forEach(([e,t],n)=>{let o=(e-r[0])*i,s=(t-r[1])*i;n===0?a.moveTo(o,s):a.lineTo(o,s)}),n.holes.push(a)}let c={depth:Id,bevelEnabled:!1};try{let t=new lo(n,c);t.rotateX(-Math.PI/2),t.computeVertexNormals();let r=new mi(t,[l.clone(),u.clone()]);r.userData={properties:e.properties,isMapMesh:!0},r.scale.y=.001,a.add(r)}catch{}let d=[];t[0].forEach(([e,t])=>{d.push(new K((e-r[0])*i,0,-(t-r[1])*i))});let f=new Pi(new Er().setFromPoints(d),new Ei({color:65535,transparent:!0,opacity:.8,depthWrite:!1}));o.add(f);let p=t[0].map(([e,t])=>new K((e-r[0])*i,0,-(t-r[1])*i)),m=new Er().setFromPoints(p),h=new Ei({color:1142691,transparent:!0,opacity:0,depthWrite:!1});s.add(new Pi(m,h))})}),a.visible=!1,a.position.y=0,o.visible=!1,s.visible=!1,t.add(a),t.add(o),t.add(s),{mapGroup:a,outlineGroup:o,topEdges:s,center:r,scale:i,EXTRUDE_DEPTH:Id}}var Rd=.35;function zd(e,t){let{center:n,scale:r}=Pd(e),i=new wn,a=[],o=new Map;e.features.forEach(e=>{if(!e||!e.geometry)return;let{coordinates:t,type:n}=e.geometry;t&&(n===`MultiPolygon`?t:[t]).forEach(e=>{let t=e[0];if(!(t.length<4))for(let e=0;e<t.length-1;e++){let n=t[e],r=t[e+1],i=`${n[0].toFixed(6)},${n[1].toFixed(6)}|${r[0].toFixed(6)},${r[1].toFixed(6)}`,a=`${r[0].toFixed(6)},${r[1].toFixed(6)}|${n[0].toFixed(6)},${n[1].toFixed(6)}`;o.has(a)?o.set(a,o.get(a)+1):o.has(i)?o.set(i,o.get(i)+1):o.set(i,1)}})});let s=[];o.forEach((e,t)=>{if(e===1){let[e,n]=t.split(`|`),[r,i]=e.split(`,`).map(Number),[a,o]=n.split(`,`).map(Number);s.push([[r,i],[a,o]])}}),Bd(s).forEach(e=>{if(e.length<10)return;let t=e.map(([e,t])=>new K((e-n[0])*r,Rd+.03,-(t-n[1])*r)),o=[],s=Math.max(1,Math.floor(t.length/600));for(let e=0;e<t.length;e+=s)o.push(t[e]);if(o.length>2&&o[0].distanceTo(o[o.length-1])<.1&&o.pop(),o.length<4)return;let c=[0];for(let e=1;e<o.length;e++)c.push(c[e-1]+o[e].distanceTo(o[e-1]));if(c[c.length-1]<10)return;let l=new ia(o,!0,`centripetal`,.5),u=Math.min(800,o.length*2),d=new mo(l,u,.004,4,!0),f=d.attributes.position.count,p=new Float32Array(f),m=u+1;for(let e=0;e<m;e++){let t=e/u;for(let n=0;n<5;n++){let r=e*5+n;r<f&&(p[r]=t)}}d.setAttribute(`aPathFrac`,new dr(p,1));function h(e){return new Co({uniforms:{uHeadPos:{value:0},uTrailLength:{value:e},uOpacity:{value:1}},vertexShader:`
        ...
        `,transparent:!0,blending:2,depthWrite:!1,depthTest:!1,side:2,toneMapped:!1})}[0,.333,.666].forEach(e=>{let t=h(.44),n=new mi(d,t);i.add(n),a.push({mesh:n,material:t,speed:4e-5,offset:e})})}),t.add(i);let c=null;function l(e){c===null&&(c=e);let t=e-c;a.forEach(e=>{let n=(e.offset+t*e.speed)%1;e.material.uniforms.uHeadPos.value=n})}function u(){c=null}return{group:i,update:l,resetTime:u}}function Bd(e){if(e.length===0)return[];let t=new Map,n=e=>`${e[0].toFixed(6)},${e[1].toFixed(6)}`;e.forEach((e,r)=>{let i=n(e[0]),a=n(e[1]);t.has(i)||t.set(i,[]),t.has(a)||t.set(a,[]),t.get(i).push(r),t.get(a).push(r)});let r=new Set,i=[];for(let a=0;a<e.length;a++){if(r.has(a))continue;let o=[],s=e[a][0];o.push(s);let c=a;for(;c!==-1&&!r.has(c);){r.add(c);let i=e[c],a=n(i[0])===n(s)?i[1]:i[0];o.push(a),s=a;let l=n(s),u=t.get(l)||[];c=-1;for(let e of u)if(!r.has(e)){c=e;break}}o.length>3&&i.push(o)}return i.sort((e,t)=>t.length-e.length),i}var Vd=.35,Hd={Gansu:`甘肃`,Qianghai:`青海`,Guangxi:`广西`,Guizhou:`贵州`,Chongqing:`重庆`,Beijing:`北京`,Fujian:`福建`,Anhui:`安徽`,Guangdong:`广东`,Tibet:`西藏`,Xinjiang:`新疆`,Hainan:`海南`,Ningxia:`宁夏`,Shaanxi:`陕西`,Shanxi:`山西`,Hubei:`湖北`,Hunan:`湖南`,Sichuan:`四川`,Yunnan:`云南`,Hebei:`河北`,Henan:`河南`,Liaoning:`辽宁`,Shandong:`山东`,Tianjin:`天津`,Jiangxi:`江西`,Jiangsu:`江苏`,Shanghai:`上海`,Zhejiang:`浙江`,Jilin:`吉林`,"Inner Mongolia":`内蒙古`,Heilongjiang:`黑龙江`,Taiwan:`台湾`,Hongkong:`香港`,Macau:`澳门`};function Ud(e,t,n,r=!1){let{center:i,scale:a}=Pd(e),o=new wn;return e.features.forEach(e=>{if(!e||!e.properties)return;let{name:t,centroid:n,center:s,longitude:l,latitude:u}=e.properties;if(!t)return;r&&Hd[t]&&(t=Hd[t]);let d=n||s||(l&&u?[l,u]:null);if(!d)return;let f=(d[0]-i[0])*a,p=-(d[1]-i[1])*a,m=document.createElement(`canvas`),h=m.getContext(`2d`),g=r?28:36;m.width=256,m.height=64,h.clearRect(0,0,m.width,m.height),h.shadowColor=`rgba(0, 170, 255, 0.4)`,h.shadowBlur=4,h.fillStyle=r?`rgba(220, 240, 255, 0.9)`:`rgba(200, 230, 255, 0.85)`,h.font=`${g}px "PingFang SC", "Microsoft YaHei", "Helvetica Neue", sans-serif`,h.textAlign=`center`,h.textBaseline=`middle`,h.fillText(t,m.width/2,m.height/2);let _=new Wi(m);_.minFilter=c;let v=new Kr(new Mr({map:_,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1,sizeAttenuation:!0,toneMapped:!1}));v.position.set(f,Vd+.4,p),v.scale.set(1,.25,1),v.renderOrder=999,o.add(v)}),t.add(o),{group:o}}function Wd(e){let t=new wn,r=new qo().load(`./wenli.jpg`);r.wrapS=n,r.wrapT=n;let i=new po(50,50),a=new Co({uniforms:{time:{value:0},wenliMap:{value:r}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,transparent:!0,depthWrite:!1,side:2}),o=new mi(i,a);o.rotation.x=-Math.PI/2,o.position.y=-.06,t.add(o),e.add(t);let s=new Er,c=new Float32Array(450);for(let e=0;e<150;e++)c[e*3]=(Math.random()-.5)*20,c[e*3+1]=Math.random()*5,c[e*3+2]=(Math.random()-.5)*20;s.setAttribute(`position`,new dr(c,3));let l=new Vi(s,new Ii({color:2254506,size:.025,transparent:!0,opacity:.3,blending:2,depthWrite:!1,sizeAttenuation:!0}));return e.add(l),{update(e){a.uniforms.time.value=e,l.rotation.y=e*5e-5;let t=l.geometry.attributes.position.array;for(let e=0;e<150;e++)t[e*3+1]+=8e-4,t[e*3+1]>5&&(t[e*3+1]=0);l.geometry.attributes.position.needsUpdate=!0}}}function Gd(e,t){let{center:n,scale:r}=Pd(e),i=new wn;.007/r;let a=.022/r;function o(e,t){let n=[],r=[];for(let i=0;i<e.length;i++){let a=e[i],o=e[i+1]||e[i],s=e[i-1]||e[i],c=new K().subVectors(o,s).normalize(),l=new K(-c.z,0,c.x).multiplyScalar(t*.5);if(n.push(a.x-l.x,a.y,a.z-l.z),n.push(a.x+l.x,a.y,a.z+l.z),i<e.length-1){let e=i*2,t=i*2+1,n=(i+1)*2,a=(i+1)*2+1;r.push(e,n,t),r.push(t,n,a)}}let i=new Er;return i.setAttribute(`position`,new mr(n,3)),i.setIndex(r),i.computeVertexNormals(),i}let s=new Map;e.features.forEach(e=>{if(!e||!e.geometry)return;let{coordinates:t,type:n}=e.geometry;t&&(n===`MultiPolygon`?t:[t]).forEach(e=>{let t=e[0];if(!(t.length<4))for(let e=0;e<t.length-1;e++){let n=t[e],r=t[e+1],i=`${n[0].toFixed(6)},${n[1].toFixed(6)}|${r[0].toFixed(6)},${r[1].toFixed(6)}`,a=`${r[0].toFixed(6)},${r[1].toFixed(6)}|${n[0].toFixed(6)},${n[1].toFixed(6)}`;s.has(a)?s.set(a,s.get(a)+1):s.has(i)?s.set(i,s.get(i)+1):s.set(i,1)}})});let c=[];s.forEach((e,t)=>{if(e===1){let[e,n]=t.split(`|`),[r,i]=e.split(`,`).map(Number),[a,o]=n.split(`,`).map(Number);c.push([[r,i],[a,o]])}});let l=Kd(c),u=[],d=0;l.forEach(e=>{if(e.length<5)return;let t=e.map(([e,t])=>new K((e-n[0])*r,.015,-(t-n[1])*r)),s=t.length;o(t,a);let c=new Er().setFromPoints(t),l=new Ei({color:4513279,transparent:!0,opacity:.8,depthWrite:!1,blending:2}),f=new Pi(c,l);f.renderOrder=5,c.setDrawRange(0,0),i.add(f),u.push({coreLine:f,coreGeometry:c,coreMaterial:l,totalVertices:s,startVertex:d}),d+=s}),t.add(i);let f=d;function p(e){let t=Math.floor(f*e);u.forEach(e=>{let n=e.startVertex+e.totalVertices,r=0;r=t<=e.startVertex?0:t>=n?e.totalVertices:t-e.startVertex,e.coreGeometry.setDrawRange(0,r)})}function m(e){u.forEach(t=>{t.coreMaterial.opacity=e*.8})}function h(e){i.visible=e}return p(0),{group:i,update:p,setOpacity:m,setVisible:h}}function Kd(e){if(e.length===0)return[];let t=new Map,n=e=>`${e[0].toFixed(6)},${e[1].toFixed(6)}`;e.forEach((e,r)=>{let i=n(e[0]),a=n(e[1]);t.has(i)||t.set(i,[]),t.has(a)||t.set(a,[]),t.get(i).push(r),t.get(a).push(r)});let r=new Set,i=[];for(let a=0;a<e.length;a++){if(r.has(a))continue;let o=[],s=e[a][0];o.push(s);let c=a;for(;c!==-1&&!r.has(c);){r.add(c);let i=e[c],a=n(i[0])===n(s)?i[1]:i[0];o.push(a),s=a;let l=n(s),u=t.get(l)||[];c=-1;for(let e of u)if(!r.has(e)){c=e;break}}o.length>3&&i.push(o)}return i.sort((e,t)=>t.length-e.length),i}function qd(e,t,n,r,i,a=`Guangdong`){let o=new wn;function s(e){let t=[],n=[];for(let r=0;r<e.length;r++){let i=e[r],a=e[(r+1)%e.length],o=e[(r-1+e.length)%e.length],s=new K().subVectors(a,o).normalize(),c=new K(-s.z,0,s.x).multiplyScalar(.025*.5),l=r*2;if(t.push(i.x-c.x,i.y,i.z-c.z),t.push(i.x+c.x,i.y,i.z+c.z),r<e.length-1){let e=l,t=l+1,r=l+2,i=l+3;n.push(e,r,t),n.push(t,r,i)}}let r=new Er;r.setAttribute(`position`,new mr(t,3)),r.setIndex(n),r.computeVertexNormals();let i=new mi(r,new ni({color:3381708,transparent:!0,opacity:0,depthWrite:!1,blending:2,toneMapped:!1,side:2}));i.userData.lineType=`core`,i.renderOrder=5,o.add(i);let a=[],s=[];for(let t=0;t<e.length;t++){let n=e[t],r=e[(t+1)%e.length],i=e[(t-1+e.length)%e.length],o=new K().subVectors(r,i).normalize(),c=new K(-o.z,0,o.x).multiplyScalar(.06*.5),l=t*2;if(a.push(n.x-c.x,n.y-.001,n.z-c.z),a.push(n.x+c.x,n.y-.001,n.z+c.z),t<e.length-1){let e=l,t=l+1,n=l+2,r=l+3;s.push(e,n,t),s.push(t,n,r)}}let c=new Er;c.setAttribute(`position`,new mr(a,3)),c.setIndex(s),c.computeVertexNormals();let l=new mi(c,new ni({color:1144746,transparent:!0,opacity:0,depthWrite:!1,blending:2,toneMapped:!1,side:2}));l.userData.lineType=`glow`,l.renderOrder=4,o.add(l)}let c=a.toLowerCase()===`china`;if(e.features.filter(e=>{if(!e||!e.properties)return!1;let t=(e.properties.name||``).trim();return c?t.toLowerCase()===`china`?!1:(e.properties.continent||``).trim().toLowerCase()===`asia`||t.toLowerCase()===`russia`:t.toLowerCase()!==a.toLowerCase()}).forEach(e=>{if(!e||!e.geometry)return;let{coordinates:t,type:i}=e.geometry;t&&(i===`MultiPolygon`?t:[t]).forEach(e=>{let t=e[0];if(!t||t.length<4||(t=Yd(t,.06),t.length<4))return;let i=t.slice(),a=i[0],o=i[i.length-1];Math.abs(a[0]-o[0])<1e-5&&Math.abs(a[1]-o[1])<1e-5&&i.pop(),!(i.length<3)&&s(new ia(i.map(([e,t])=>new K((e-n[0])*r,.015,-(t-n[1])*r)),!0,`centripetal`,.5).getPoints(i.length*3))})}),t){let e=new Map;t.features.forEach(t=>{if(!t||!t.geometry)return;let{coordinates:n}=t.geometry;n&&n.forEach(t=>{let n=t[0];if(!(n.length<4))for(let t=0;t<n.length-1;t++){let r=n[t],i=n[t+1],a=`${r[0].toFixed(6)},${r[1].toFixed(6)}|${i[0].toFixed(6)},${i[1].toFixed(6)}`,o=`${i[0].toFixed(6)},${i[1].toFixed(6)}|${r[0].toFixed(6)},${r[1].toFixed(6)}`;e.has(o)?e.set(o,e.get(o)+1):e.has(a)?e.set(a,e.get(a)+1):e.set(a,1)}})});let i=[];e.forEach((e,t)=>{if(e===1){let[e,n]=t.split(`|`),[r,a]=e.split(`,`).map(Number),[o,s]=n.split(`,`).map(Number);i.push([[r,a],[o,s]])}}),Xd(i).forEach(e=>{if(e.length<6)return;let t=Yd(e,.02);if(t.length<4)return;let i=t.slice(),a=i[0],o=i[i.length-1];Math.abs(a[0]-o[0])<1e-5&&Math.abs(a[1]-o[1])<1e-5&&i.pop(),!(i.length<3)&&s(new ia(i.map(([e,t])=>new K((e-n[0])*r,.015,-(t-n[1])*r)),!0,`centripetal`,.5).getPoints(i.length*3))})}o.visible=!1,i.add(o);function l(e){let t=Math.max(0,Math.min(e,1));o.children.forEach(e=>{e.userData.lineType===`core`?e.material.opacity=t*.08:e.material.opacity=t*.03})}function u(e){o.visible=e}return{group:o,setOpacity:l,setVisible:u}}function Jd(e,t,n){let r=n[0]-t[0],i=n[1]-t[1];return r===0&&i===0?Math.sqrt((e[0]-t[0])**2+(e[1]-t[1])**2):Math.abs(i*e[0]-r*e[1]+n[0]*t[1]-n[1]*t[0])/Math.sqrt(r*r+i*i)}function Yd(e,t){if(e.length<=2)return e;let n=0,r=0,i=e.length-1;for(let t=1;t<i;t++){let a=Jd(e[t],e[0],e[i]);a>n&&(r=t,n=a)}if(n>t){let n=Yd(e.slice(0,r+1),t),i=Yd(e.slice(r),t);return n.slice(0,n.length-1).concat(i)}else return[e[0],e[i]]}function Xd(e){if(e.length===0)return[];let t=new Map,n=e=>`${e[0].toFixed(6)},${e[1].toFixed(6)}`;e.forEach((e,r)=>{let i=n(e[0]),a=n(e[1]);t.has(i)||t.set(i,[]),t.has(a)||t.set(a,[]),t.get(i).push(r),t.get(a).push(r)});let r=new Set,i=[];for(let a=0;a<e.length;a++){if(r.has(a))continue;let o=[],s=e[a][0];o.push(s);let c=a;for(;c!==-1&&!r.has(c);){r.add(c);let i=e[c],a=n(i[0])===n(s)?i[1]:i[0];o.push(a),s=a;let l=n(s),u=t.get(l)||[];c=-1;for(let e of u)if(!r.has(e)){c=e;break}}o.length>3&&i.push(o)}return i.sort((e,t)=>t.length-e.length),i}function Zd(e,t){let{center:n,scale:r}=Pd(e),i=new po(50,50),a=new Co({uniforms:{uCenter:{value:new G(0,0)},uRippleProgress:{value:0},uRippleWidth:{value:2.5},uMaxRadius:{value:24},uOpacity:{value:1}},vertexShader:`
    ...
    `,transparent:!0,depthWrite:!1,blending:2,side:2}),o=new mi(i,a);return o.rotation.x=-Math.PI/2,o.position.y=-.055,o.renderOrder=2,t.add(o),{mesh:o,setVisible(e){o.visible=e},update(e,t,n,r=!1){if(e<t){a.uniforms.uRippleProgress.value=0,o.visible=!1;return}o.visible=!0;let i=e-t,s=1-(1-(r?i%n/n:Math.min(i/n,1)))**2;a.uniforms.uRippleProgress.value=s}}}var Qd=null,$d={CHINA_INTRO:`china_intro`,CHINA_ACTIVE:`china_active`,PROVINCE_LOADING:`province_loading`,PROVINCE_INTRO:`province_intro`,PROVINCE_ACTIVE:`province_active`,TRANSITION_TO_CHINA:`transition_to_china`},ef=null,tf=0,Q=null,nf=null,rf=null,af=null,of=null,sf=null,$={mapGroup:null,outlineGroup:null,topEdges:null,flowingLights:null,labels:null,outlineDrawing:null,neighbors:null,ripple:null,extrudeDepth:.35,name:``,adcode:null,geoData:null,center:null},cf=``,lf=!1,uf=!1,df=0,ff=!1,pf=[],mf=null,hf=new K,gf=new K,_f=document.getElementById(`map-container`),vf=new Mn,yf=new os(45,window.innerWidth/window.innerHeight,.1,1e3),bf=new K(-.6,6.6,12),xf=new K(-.24,14.4,4.8);new K(-.5,5.5,10);var Sf=new K(-.2,12,4),Cf=new K,wf=new K,Tf=null;yf.position.copy(bf),yf.lookAt(0,0,0);var Ef=new Qu({antialias:!0,alpha:!0,powerPreference:`high-performance`});Ef.setSize(window.innerWidth,window.innerHeight),Ef.setPixelRatio(Math.min(window.devicePixelRatio,2)),Ef.setClearColor(658970,1),Ef.toneMapping=4,Ef.toneMappingExposure=1,_f.appendChild(Ef.domElement);var Df=new ld(yf,Ef.domElement);Df.enableDamping=!0,Df.dampingFactor=.08,Df.enablePan=!0,Df.enableZoom=!0,Df.enableRotate=!0,Df.minDistance=3,Df.maxDistance=30,Df.maxPolarAngle=Math.PI/2.1,Df.minPolarAngle=.2,Df.target.set(0,0,0),Df.update(),Df.enabled=!1;var Of=new Ad(Ef);Of.addPass(new jd(vf,yf));var kf=new Nd(new G(window.innerWidth,window.innerHeight),.7,.5,.85);Of.addPass(kf);var Af=new us(3359846,.6);vf.add(Af);var jf=new ls(4491468,.8);jf.position.set(5,10,7),vf.add(jf);var Mf={outlineDuration:1200,growDelay:1200,growDuration:1200,labelDelay:2400,labelDuration:600,camStart:3e3,camEnd:5e3},Nf={duration:1200,rippleStart:0,rippleDuration:5e3},Pf=new As,Ff=new G,If=document.getElementById(`tooltip`),Lf=null,Rf={Gansu:`甘肃`,Qianghai:`青海`,Guangxi:`广西`,Guizhou:`贵州`,Chongqing:`重庆`,Beijing:`北京`,Fujian:`福建`,Anhui:`安徽`,Guangdong:`广东`,Tibet:`西藏`,Xinjiang:`新疆`,Hainan:`海南`,Ningxia:`宁夏`,Shaanxi:`陕西`,Shanxi:`山西`,Hubei:`湖北`,Hunan:`湖南`,Sichuan:`四川`,Yunnan:`云南`,Hebei:`河北`,Henan:`河南`,Liaoning:`辽宁`,Shandong:`山东`,Tianjin:`天津`,Jiangxi:`江西`,Jiangsu:`江苏`,Shanghai:`上海`,Zhejiang:`浙江`,Jilin:`吉林`,"Inner Mongolia":`内蒙古`,Heilongjiang:`黑龙江`,Taiwan:`台湾`,Hongkong:`香港`,Macau:`澳门`};function zf(e){Q&&(Q.mapGroup.children.forEach(t=>{t.material[0]&&t.material[0].uniforms&&(t.material[0].uniforms.opacity.value=e,t.material[0].transparent=e<1),t.material[1]&&t.material[1].uniforms&&(t.material[1].uniforms.opacity.value=e,t.material[1].transparent=e<1)}),Q.outlineGroup.children.forEach(t=>{t.material.opacity=e*.4}),Q.topEdges.children.forEach(t=>{t.material.opacity=e*.3})),nf&&nf.group&&nf.group.children.forEach(t=>{t.material.opacity=e}),af&&af.group&&af.group.children.forEach(t=>{t.material&&t.material.uniforms&&t.material.uniforms.uOpacity&&(t.material.uniforms.uOpacity.value=e)}),of&&of.setOpacity(e),sf&&sf.mesh&&sf.mesh.material.uniforms&&(sf.mesh.material.uniforms.uOpacity.value=e)}function Bf(e){$.mapGroup&&$.mapGroup.children.forEach(t=>{t.material[0]&&t.material[0].uniforms&&(t.material[0].uniforms.opacity.value=e,t.material[0].transparent=e<1),t.material[1]&&t.material[1].uniforms&&(t.material[1].uniforms.opacity.value=e,t.material[1].transparent=e<1)}),$.labels&&$.labels.group&&$.labels.group.children.forEach(t=>{t.material.opacity=e}),$.outlineGroup&&$.outlineGroup.children.forEach(t=>{t.material.opacity=e*.8}),$.topEdges&&$.topEdges.children.forEach(t=>{t.material.opacity=e*.6}),$.flowingLights&&$.flowingLights.group&&$.flowingLights.group.children.forEach(t=>{t.material&&t.material.uniforms&&t.material.uniforms.uOpacity&&(t.material.uniforms.uOpacity.value=e)}),$.neighbors&&$.neighbors.setOpacity(e),$.ripple&&$.ripple.mesh&&$.ripple.mesh.material.uniforms&&($.ripple.mesh.material.uniforms.uOpacity.value=e)}function Vf(e,t){e.mapGroup&&e.mapGroup.children.forEach(e=>{e.material[0]&&e.material[0].uniforms&&(e.material[0].uniforms.opacity.value=t,e.material[0].transparent=t<1),e.material[1]&&e.material[1].uniforms&&(e.material[1].uniforms.opacity.value=t,e.material[1].transparent=t<1)}),e.labels&&e.labels.group&&e.labels.group.children.forEach(e=>{e.material.opacity=t}),e.outlineGroup&&e.outlineGroup.children.forEach(e=>{e.material.opacity=t*.8}),e.topEdges&&e.topEdges.children.forEach(e=>{e.material.opacity=t*.6}),e.flowingLights&&e.flowingLights.group&&e.flowingLights.group.children.forEach(e=>{e.material&&e.material.uniforms&&e.material.uniforms.uOpacity&&(e.material.uniforms.uOpacity.value=t)}),e.neighbors&&e.neighbors.setOpacity(t),e.ripple&&e.ripple.mesh&&e.ripple.mesh.material.uniforms&&(e.ripple.mesh.material.uniforms.uOpacity.value=t)}function Hf(e){pf.length===0?zf(e):Vf(pf[pf.length-1],e)}function Uf(e,t){e&&(e.traverse(e=>{(e.isMesh||e.isLine||e.isSprite)&&(e.geometry&&e.geometry.dispose(),e.material&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose()))}),t.remove(e))}function Wf(){$.mapGroup&&Uf($.mapGroup,vf),$.outlineGroup&&Uf($.outlineGroup,vf),$.topEdges&&Uf($.topEdges,vf),$.flowingLights&&$.flowingLights.group&&Uf($.flowingLights.group,vf),$.labels&&$.labels.group&&Uf($.labels.group,vf),$.outlineDrawing&&$.outlineDrawing.group&&Uf($.outlineDrawing.group,vf),$.neighbors&&$.neighbors.group&&Uf($.neighbors.group,vf),$.ripple&&$.ripple.mesh&&(vf.remove($.ripple.mesh),$.ripple.mesh.geometry.dispose(),$.ripple.mesh.material.dispose()),$={mapGroup:null,outlineGroup:null,topEdges:null,flowingLights:null,labels:null,outlineDrawing:null,neighbors:null,ripple:null,extrudeDepth:.35,name:``,adcode:null,geoData:null,center:null}}function Gf(e){let t=null;if(e.length>0){let n=e[0].object;n.userData&&n.userData.properties&&(t=n.userData.properties.name)}let n=ef===$d.CHINA_ACTIVE?Q:$;t!==Lf&&(Lf&&n&&n.mapGroup.children.forEach(e=>{e.userData&&e.userData.properties&&e.userData.properties.name===Lf&&(e.material[0]&&e.material[0].uniforms&&(e.material[0].uniforms.uHover.value=0),e.material[1]&&e.material[1].uniforms&&(e.material[1].uniforms.uHover.value=0))}),Lf=t,Lf&&n?(n.mapGroup.children.forEach(e=>{e.userData&&e.userData.properties&&e.userData.properties.name===Lf&&(e.material[0]&&e.material[0].uniforms&&(e.material[0].uniforms.uHover.value=1),e.material[1]&&e.material[1].uniforms&&(e.material[1].uniforms.uHover.value=1))}),ef===$d.CHINA_ACTIVE||ef===$d.PROVINCE_ACTIVE&&pf.length===0?(document.body.style.cursor=`pointer`,If.innerHTML=`<div style="font-weight:bold;color:#00c3ff;text-align:center;">${Rf[Lf]||Lf}</div><div style="font-size:11px;color:#88aacc;margin-top:4px;">${ef===$d.CHINA_ACTIVE?`点击下钻 3D 城市地图`:`点击下钻 3D 区县地图`}</div>`):(document.body.style.cursor=`default`,If.innerHTML=`<div style="font-weight:bold;color:#00c3ff;text-align:center;">${Rf[Lf]||Lf}</div>`),If.style.display=`block`):(document.body.style.cursor=`default`,If.style.display=`none`))}function Kf(){let e=Ld(mf,vf),t=zd(mf,vf),n=Ud(mf,vf,yf,!1),r=Zd(mf,vf),{center:i,scale:a}=Pd(mf),o=qd(pf.length>0?pf[pf.length-1].geoData:Qd,mf,i,a,vf,cf);$={mapGroup:e.mapGroup,outlineGroup:e.outlineGroup,topEdges:e.topEdges,flowingLights:t,labels:n,outlineDrawing:null,neighbors:o,ripple:r,extrudeDepth:e.EXTRUDE_DEPTH,name:cf,scale:a,center:i,adcode:Jf,geoData:mf},$.mapGroup.visible=!0,$.outlineGroup.visible=!0,$.topEdges.visible=!0,$.flowingLights.group.visible=!0,$.labels.group.visible=!0,$.neighbors.setVisible(!0),$.ripple.setVisible(!0),$.mapGroup.children.forEach(e=>{e.scale.y=1}),$.outlineGroup.position.y=$.extrudeDepth+.01,$.topEdges.position.y=$.extrudeDepth+.015;let s=(pf.length>0?pf[pf.length-1].scale:Q.scale)/a;$.mapGroup.position.copy(gf),$.outlineGroup.position.copy(gf),$.topEdges.position.copy(gf),$.flowingLights.group.position.copy(gf),$.labels.group.position.copy(gf),$.neighbors.group.position.copy(gf),$.mapGroup.scale.set(s,s,s),$.outlineGroup.scale.set(s,s,s),$.topEdges.scale.set(s,s,s),$.flowingLights.group.scale.set(s,s,s),$.labels.group.scale.set(s,s,s),$.neighbors.group.scale.set(s,s,s),Bf(0),uf=!0}function qf(e){if(!e||!e.geometry)return[0,0];let{coordinates:t,type:n}=e.geometry;if(!t)return[0,0];let r=n===`MultiPolygon`?t:[t],i=1/0,a=-1/0,o=1/0,s=-1/0,c=0;return r.forEach(e=>{!e||!e[0]||e[0].forEach(([e,t])=>{i=Math.min(i,e),a=Math.max(a,e),o=Math.min(o,t),s=Math.max(s,t),c++})}),c===0?[0,0]:[(i+a)/2,(o+s)/2]}var Jf=null;async function Yf(e,t){if(ef===$d.PROVINCE_ACTIVE){let e={...$};pf.push(e)}else ef===$d.CHINA_ACTIVE&&Wf();if(ef=$d.PROVINCE_LOADING,tf=performance.now(),Df.enabled=!1,cf=e,Jf=t,lf=!1,mf=null,uf=!1,Lf){let e=pf.length>0?$:Q;e&&e.mapGroup.children.forEach(e=>{e.userData&&e.userData.properties&&e.userData.properties.name===Lf&&(e.material[0]&&e.material[0].uniforms&&(e.material[0].uniforms.uHover.value=0),e.material[1]&&e.material[1].uniforms&&(e.material[1].uniforms.uHover.value=0))})}Lf=null,If.style.display=`none`,document.body.style.cursor=`default`;let n,r,i;if(pf.length>0){let e=pf[pf.length-1];n=e.center,r=e.scale,i=e.geoData.features}else n=Q.center,r=Q.scale,i=Qd.features;let a=i.find(t=>t&&t.properties&&t.properties.name===e),o=0,s=0;if(a){let e=a.properties.centroid||a.properties.center||(a.properties.longitude?[a.properties.longitude,a.properties.latitude]:null);(!e||typeof e[0]!=`number`||typeof e[1]!=`number`)&&(e=qf(a)),o=(e[0]-n[0])*r,s=-(e[1]-n[1])*r}gf.set(o,0,s),hf.copy(yf.position),Qf(e,t)}function Xf(e,t=3e3){let n=document.getElementById(`error-toast`);n||(n=document.createElement(`div`),n.id=`error-toast`,n.style.cssText=`
    ...
    `,document.body.appendChild(n)),n.textContent=e,n.style.opacity=`1`,n.style.display=`block`,clearTimeout(n._timer),n._timer=setTimeout(()=>{n.style.opacity=`0`,setTimeout(()=>{n.style.display=`none`},400)},t)}async function Zf(e,t=2){for(let n=0;n<=t;n++)try{let t=await fetch(e,{referrerPolicy:`no-referrer`});if(!t.ok)throw Error(`HTTP ${t.status}`);return await t.json()}catch(r){if(console.warn(`[Map] Fetch attempt ${n+1} failed for ${e}:`,r.message),n===t)throw r;await new Promise(e=>setTimeout(e,500*(n+1)))}}async function Qf(e,t){let n;if(t===44)n=await(await fetch(`./guangdong.json`)).json();else{let r=t;typeof t==`number`&&t<100&&(r=t*1e4),console.log(`[Map] Loading geo data: name=${e}, id=${t}, urlId=${r}`);try{n=await Zf(`https://geo.datav.aliyun.com/areas_v3/bound/${r}_full.json`)}catch{console.warn(`[Map] Full map failed, trying boundary only...`);try{n=await Zf(`https://geo.datav.aliyun.com/areas_v3/bound/${r}.json`)}catch{console.error(`[Map] All fetch attempts failed for`,r),Xf(`数据加载失败，请检查网络后重试`),document.getElementById(`loading-overlay`).classList.remove(`visible`),Hf(1),pf.length>0?($=pf.pop(),Bf(1),$.mapGroup&&($.mapGroup.visible=!0),$.outlineGroup&&($.outlineGroup.visible=!0),$.topEdges&&($.topEdges.visible=!0),$.flowingLights&&$.flowingLights.group&&($.flowingLights.group.visible=!0),$.labels&&$.labels.group&&($.labels.group.visible=!0),$.neighbors&&$.neighbors.setVisible(!0),$.ripple&&$.ripple.setVisible(!0),ef=$d.PROVINCE_ACTIVE):(Q&&(Q.mapGroup.visible=!0,Q.outlineGroup.visible=!0,Q.topEdges.visible=!0),nf&&nf.group&&(nf.group.visible=!0),af&&af.group&&(af.group.visible=!0),of&&of.setVisible(!0),sf&&sf.setVisible(!0),ef=$d.CHINA_ACTIVE),Df.enabled=!0;return}}}mf=n,lf=!0}async function $f(){let[e,t]=await Promise.all([fetch(`./china_provinces.json`),fetch(`./world_countries.json`)]),n=await e.json(),r=await t.json();Qd=n;let i=Wd(vf);Q=Ld(n,vf),nf=Ud(n,vf,yf,!0),rf=Gd(n,vf),af=zd(n,vf),of=qd(r,null,Q.center,Q.scale,vf,`China`),sf=Zd(n,vf),Q.mapGroup.visible=!1,Q.outlineGroup.visible=!1,Q.topEdges.visible=!1,nf.group.visible=!1,af.group.visible=!1,of&&(of.setVisible(!1),of.setOpacity(0)),sf&&sf.setVisible(!1),setTimeout(()=>{tf=performance.now(),ef=$d.CHINA_INTRO},300);function a(e){if(requestAnimationFrame(a),ef===null){i.update(e),Of.render();return}let t=e-tf;if(ef===$d.CHINA_INTRO){rf.setVisible(!0),t<=Mf.growDelay&&rf.setOpacity(1);let n=Math.min(t/Mf.outlineDuration,1);if(rf.update(n),t>=1e3){if(of){of.setVisible(!0);let e=Math.min((t-1e3)/1e3,1);of.setOpacity(e)}sf&&(sf.setVisible(!0),sf.update(t,1e3,5e3,!0))}if(t>Mf.outlineDuration){let e=Math.min((t-Mf.growDelay)/Mf.growDuration,1),n=ep(e);e>0&&(Q.mapGroup.visible=!0,Q.outlineGroup.visible=!0,Q.topEdges.visible=!0,Q.mapGroup.children.forEach(e=>{e.scale.y=Math.max(.001,n),e.material[0]&&e.material[0].uniforms&&(e.material[0].uniforms.opacity.value=1),e.material[1]&&e.material[1].uniforms&&(e.material[1].uniforms.opacity.value=1)}),Q.outlineGroup.position.y=(Q.EXTRUDE_DEPTH+.01)*n,Q.outlineGroup.children.forEach(e=>{e.material.opacity=n*.4}),Q.topEdges.position.y=(Q.EXTRUDE_DEPTH+.015)*n,Q.topEdges.children.forEach(e=>{e.material.opacity=n*.3}),rf.setOpacity(1-tp(Math.min((t-Mf.growDelay)/720,1))),af.group.visible=!0,af.group.position.y=(Q.EXTRUDE_DEPTH+.03)*(n-1),af.group.children.forEach(e=>{e.material&&e.material.uniforms&&e.material.uniforms.uOpacity&&(e.material.uniforms.uOpacity.value=n)}))}if(t>=Mf.growDelay&&af.update(e),t>Mf.labelDelay){let e=tp(Math.min((t-Mf.labelDelay)/Mf.labelDuration,1));nf.group.visible=!0,nf.group.children.forEach(t=>{t.material.opacity=e})}if(t>=Mf.camStart){let e=Mf.camEnd-Mf.camStart,n=np(Math.min((t-Mf.camStart)/e,1));yf.position.lerpVectors(bf,xf,n),yf.lookAt(0,0,0),Df.target.set(0,0,0),Df.update(),t>=Mf.camEnd&&(ef=$d.CHINA_ACTIVE,Df.enabled=!0,rf.setVisible(!1))}else yf.position.copy(bf),yf.lookAt(0,0,0)}else if(ef===$d.CHINA_ACTIVE)Df.update(),af.update(e),sf&&(sf.setVisible(!0),sf.update(t,1e3,5e3,!0)),of&&(of.setVisible(!0),of.setOpacity(1)),ff&&(Pf.setFromCamera(Ff,yf),Gf(Pf.intersectObjects(Q.mapGroup.children,!0)));else if(ef===$d.PROVINCE_LOADING){let n=Math.min(t/1e3,1),r=np(n);if(yf.position.lerpVectors(hf,Sf,r),yf.lookAt(0,0,0),Df.target.set(0,0,0),Df.update(),Hf(1-r),lf){uf||(Kf(),df=performance.now());let t=e-df,n=np(Math.min(t/800,1)),r=(pf.length>0?pf[pf.length-1].scale:Q.scale)/$.scale,i=r+n*(1-r),a=new K().lerpVectors(gf,new K(0,0,0),n);$.mapGroup&&($.mapGroup.position.copy(a),$.outlineGroup.position.copy(a),$.outlineGroup.position.y+=($.extrudeDepth+.01)*n,$.topEdges.position.copy(a),$.topEdges.position.y+=($.extrudeDepth+.015)*n,$.flowingLights.group.position.copy(a),$.labels.group.position.copy(a),$.neighbors.group.position.copy(a),$.mapGroup.scale.set(i,i,i),$.outlineGroup.scale.set(i,i,i),$.topEdges.scale.set(i,i,i)),$.flowingLights&&$.flowingLights.group&&$.flowingLights.group.scale.set(i,i,i),$.labels&&$.labels.group&&$.labels.group.scale.set(i,i,i),$.neighbors&&$.neighbors.group&&$.neighbors.group.scale.set(i,i,i),Bf(n),$.flowingLights.update(e),$.ripple&&$.ripple.update(t,Nf.rippleStart,Nf.rippleDuration)}if(n>=1)if(lf&&uf&&e-df>=800){ef=$d.PROVINCE_ACTIVE,Df.enabled=!0,$.mapGroup&&($.mapGroup.position.set(0,0,0),$.outlineGroup.position.set(0,$.extrudeDepth+.01,0),$.topEdges.position.set(0,$.extrudeDepth+.015,0),$.flowingLights.group.position.set(0,0,0),$.labels.group.position.set(0,0,0),$.neighbors.group.position.set(0,0,0),$.mapGroup.scale.set(1,1,1),$.outlineGroup.scale.set(1,1,1),$.topEdges.scale.set(1,1,1),$.flowingLights.group.scale.set(1,1,1),$.labels.group.scale.set(1,1,1),$.neighbors.group.scale.set(1,1,1));let e=document.getElementById(`back-btn`);if(e.style.display=`flex`,pf.length>0){let e=pf[pf.length-1];e.mapGroup&&(e.mapGroup.visible=!1),e.outlineGroup&&(e.outlineGroup.visible=!1),e.topEdges&&(e.topEdges.visible=!1),e.flowingLights&&e.flowingLights.group&&(e.flowingLights.group.visible=!1),e.labels&&e.labels.group&&(e.labels.group.visible=!1),e.neighbors&&e.neighbors.setVisible(!1),e.ripple&&e.ripple.setVisible(!1)}else Q&&(Q.mapGroup.visible=!1,Q.outlineGroup.visible=!1,Q.topEdges.visible=!1),nf&&nf.group&&(nf.group.visible=!1),af&&af.group&&(af.group.visible=!1),of&&of.setVisible(!1),sf&&sf.setVisible(!1);ap(),document.getElementById(`loading-overlay`).classList.remove(`visible`)}else{let e=document.getElementById(`loading-overlay`),t=document.getElementById(`loading-text`);e.classList.add(`visible`),t.innerText=`正在加载 ${Rf[cf]||cf} 3D数据...`}}else if(ef===$d.PROVINCE_ACTIVE){Df.update(),$.flowingLights.update(e);let n=.35+.1*Math.sin(e*.002);$.outlineGroup.children.forEach(e=>{e.material.opacity=n}),$.ripple&&$.ripple.update(t,Nf.rippleStart,Nf.rippleDuration,!0),ff&&(Pf.setFromCamera(Ff,yf),Gf(Pf.intersectObjects($.mapGroup.children,!0)))}else if(ef===$d.TRANSITION_TO_CHINA){let e=Math.min(t/1500,1),n=np(e);if(yf.position.lerpVectors(Cf,wf,n),yf.lookAt(0,0,0),Df.target.set(0,0,0),Df.update(),$.mapGroup){let e=1-n*(1-(Tf?Tf.scale:Q.scale)/$.scale),t=new K().lerpVectors(new K(0,0,0),gf,n);$.mapGroup.position.copy(t),$.outlineGroup.position.copy(t),$.outlineGroup.position.y+=($.extrudeDepth+.01)*(1-n),$.topEdges.position.copy(t),$.topEdges.position.y+=($.extrudeDepth+.015)*(1-n),$.flowingLights.group.position.copy(t),$.labels.group.position.copy(t),$.neighbors.group.position.copy(t),$.mapGroup.scale.set(e,e,e),$.outlineGroup.scale.set(e,e,e),$.topEdges.scale.set(e,e,e),$.flowingLights.group.scale.set(e,e,e),$.labels.group.scale.set(e,e,e),$.neighbors.group.scale.set(e,e,e)}if(Bf(1-Math.min(t/500,1)),t>=500)if($.mapGroup&&($.mapGroup.visible=!1),$.outlineGroup&&($.outlineGroup.visible=!1),$.topEdges&&($.topEdges.visible=!1),$.flowingLights&&$.flowingLights.group&&($.flowingLights.group.visible=!1),$.labels&&$.labels.group&&($.labels.group.visible=!1),$.neighbors&&$.neighbors.setVisible(!1),$.ripple&&$.ripple.setVisible(!1),Tf){Tf.mapGroup&&(Tf.mapGroup.visible=!0),Tf.outlineGroup&&(Tf.outlineGroup.visible=!0),Tf.topEdges&&(Tf.topEdges.visible=!0),Tf.flowingLights&&Tf.flowingLights.group&&(Tf.flowingLights.group.visible=!0),Tf.labels&&Tf.labels.group&&(Tf.labels.group.visible=!0),Tf.neighbors&&Tf.neighbors.setVisible(!0),Tf.ripple&&Tf.ripple.setVisible(!0);let e=Math.min((t-500)/1e3,1);Vf(Tf,e),Tf.ripple&&Tf.ripple.update(t-500,0,5e3,!0)}else Q.mapGroup.visible=!0,Q.outlineGroup.visible=!0,Q.topEdges.visible=!0,nf.group.visible=!0,af.group.visible=!0,of&&of.setVisible(!0),sf&&sf.setVisible(!0),zf(Math.min((t-500)/1e3,1)),sf&&sf.update(t-500,0,5e3,!0);e>=1&&(Tf?(ef=$d.PROVINCE_ACTIVE,Wf(),$=Tf,Tf=null,Bf(1),Df.enabled=!0,tf=performance.now(),ap(),document.getElementById(`back-btn`).style.display=`flex`):(ef=$d.CHINA_ACTIVE,Df.enabled=!0,tf=performance.now(),setTimeout(()=>{Wf()},50)))}i.update(e),Of.render()}requestAnimationFrame(a)}function ep(e){return 1-(1-e)**3}function tp(e){return e<.5?2*e*e:1-(-2*e+2)**2/2}function np(e){return e<.5?4*e*e*e:1-(-2*e+2)**3/2}window.addEventListener(`resize`,()=>{yf.aspect=window.innerWidth/window.innerHeight,yf.updateProjectionMatrix(),Ef.setSize(window.innerWidth,window.innerHeight),Of.setSize(window.innerWidth,window.innerHeight)}),window.addEventListener(`mousemove`,e=>{ff=!0,Ff.x=e.clientX/window.innerWidth*2-1,Ff.y=-(e.clientY/window.innerHeight)*2+1,If.style.left=e.clientX+15+`px`,If.style.top=e.clientY+15+`px`});var rp=!1,ip={x:0,y:0};window.addEventListener(`mousedown`,e=>{rp=!1,ip.x=e.clientX,ip.y=e.clientY}),window.addEventListener(`mouseup`,e=>{let t=e.clientX-ip.x,n=e.clientY-ip.y;Math.sqrt(t*t+n*n)>5&&(rp=!0)}),window.addEventListener(`click`,()=>{if(!rp){if(ef===$d.CHINA_ACTIVE&&Lf){let e=Lf,t=Qd.features.find(t=>t.properties.name===e);if(t){let n=t.properties.id;Yf(e,n)}}else if(ef===$d.PROVINCE_ACTIVE&&Lf&&pf.length===0){let e=Lf,t=$.geoData.features.find(t=>t.properties.name===e);if(t){let n=t.properties.adcode;Yf(e,n)}}}}),document.getElementById(`back-btn`).addEventListener(`click`,()=>{if(ef===$d.PROVINCE_ACTIVE){if(ff=!1,Cf.copy(yf.position),pf.length>0){Tf=pf.pop(),wf.copy(Sf);let e=Tf.center,t=Tf.scale,n=Tf.geoData.features.find(e=>e&&e.properties&&e.properties.name===$.name),r=0,i=0;if(n){let a=n.properties.centroid||n.properties.center||(n.properties.longitude?[n.properties.longitude,n.properties.latitude]:null);(!a||typeof a[0]!=`number`||typeof a[1]!=`number`)&&(a=qf(n)),r=(a[0]-e[0])*t,i=-(a[1]-e[1])*t}gf.set(r,0,i)}else{Tf=null,wf.copy(xf);let e=Qd.features.find(e=>e&&e.properties&&e.properties.name===$.name),t=0,n=0;if(e){let r=e.properties.centroid||e.properties.center||(e.properties.longitude?[e.properties.longitude,e.properties.latitude]:null);(!r||typeof r[0]!=`number`||typeof r[1]!=`number`)&&(r=qf(e)),t=(r[0]-Q.center[0])*Q.scale,n=-(r[1]-Q.center[1])*Q.scale}gf.set(t,0,n)}ef=$d.TRANSITION_TO_CHINA,tf=performance.now(),document.getElementById(`back-btn`).style.display=`none`,Df.enabled=!1}});function ap(){let e=document.getElementById(`back-btn`);if(!e)return;let t=`返回中国地图`;if(pf.length>0){let e=pf[pf.length-1].name;t=`返回${Rf[e]||e}地图`}e.innerHTML=`
