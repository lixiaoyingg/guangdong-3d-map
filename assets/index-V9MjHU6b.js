...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ic(e,t,n){let r=new Float32Array(Ws),i=new J(0,1,0);return new xo({name:`SphericalGaussianBlur`,defines:{n:Ws,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:sc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ac(){return new xo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:sc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function oc(){return new xo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:sc(),fragmentShader:`
	...
	`}var cc=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Vi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Dd.BlurDirectionX=new q(1,0),Dd.BlurDirectionY=new q(0,1);function Od(e){let t=1/0,n=-1/0,r=1/0,i=-1/0;e.features.forEach(e=>{e.geometry.coordinates.forEach(e=>{e.forEach(e=>{e.forEach(([e,a])=>{t=Math.min(t,e),n=Math.max(n,e),r=Math.min(r,a),i=Math.max(i,a)})})})});let a=[(t+n)/2,(r+i)/2],o=n-t,s=i-r;return{center:a,scale:10/Math.max(o,s)}}function kd(e,t,n){let r=new Ca;return e.forEach(([e,i],a)=>{let o=(e-t[0])*n,s=(i-t[1])*n;a===0?r.moveTo(o,s):r.lineTo(o,s)}),r}var Ad=.35;function jd(e,t){let{center:r,scale:i}=Od(e),a=new Sn,o=new Sn,s=new Sn,c=new Go().load(`./wenli.jpg`);c.wrapS=n,c.wrapT=n;let l=new xo({uniforms:{wenliMap:{value:c},opacity:{value:0}},vertexShader:`
    ...
    `,transparent:!0,side:2,depthWrite:!0}),u=new xo({uniforms:{bottomColor:{value:new Z(26316)},topColor:{value:new Z(330258)},opacity:{value:0},extrudeDepth:{value:Ad}},vertexShader:`
    ...
    `,transparent:!0,side:2,depthWrite:!0});return e.features.forEach(e=>{let{coordinates:t}=e.geometry;t.forEach(e=>{if(e[0].length<4)return;let t=kd(e[0],r,i);for(let n=1;n<e.length;n++)if(e[n].length>=4){let a=new Sa;e[n].forEach(([e,t],n)=>{let o=(e-r[0])*i,s=(t-r[1])*i;n===0?a.moveTo(o,s):a.lineTo(o,s)}),t.holes.push(a)}let n={depth:Ad,bevelEnabled:!1};try{let e=new so(t,n);e.rotateX(-Math.PI/2),e.computeVertexNormals();let r=new fi(e,[l.clone(),u.clone()]);r.scale.y=.001,a.add(r)}catch{}let c=[];e[0].forEach(([e,t])=>{c.push(new J((e-r[0])*i,0,-(t-r[1])*i))});let d=new Mi(new wr().setFromPoints(c),new wi({color:54527,transparent:!0,opacity:0,depthWrite:!1,blending:2}));o.add(d);let f=e[0].map(([e,t])=>new J((e-r[0])*i,0,-(t-r[1])*i)),p=new wr().setFromPoints(f),m=new wi({color:1739469,transparent:!0,opacity:0,depthWrite:!1,blending:2});s.add(new Mi(p,m))})}),a.visible=!1,a.position.y=0,o.visible=!1,s.visible=!1,t.add(a),t.add(o),t.add(s),{mapGroup:a,outlineGroup:o,topEdges:s,center:r,scale:i,EXTRUDE_DEPTH:Ad}}var Md=.35;function Nd(e,t){let{center:n,scale:r}=Od(e),i=new Sn,a=[],o=new Map;e.features.forEach(e=>{let{coordinates:t}=e.geometry;t.forEach(e=>{let t=e[0];if(!(t.length<4))for(let e=0;e<t.length-1;e++){let n=t[e],r=t[e+1],i=`${n[0].toFixed(6)},${n[1].toFixed(6)}|${r[0].toFixed(6)},${r[1].toFixed(6)}`,a=`${r[0].toFixed(6)},${r[1].toFixed(6)}|${n[0].toFixed(6)},${n[1].toFixed(6)}`;o.has(a)?o.set(a,o.get(a)+1):o.has(i)?o.set(i,o.get(i)+1):o.set(i,1)}})});let s=[];o.forEach((e,t)=>{if(e===1){let[e,n]=t.split(`|`),[r,i]=e.split(`,`).map(Number),[a,o]=n.split(`,`).map(Number);s.push([[r,i],[a,o]])}}),Pd(s).forEach(e=>{if(e.length<10)return;let t=e.map(([e,t])=>new J((e-n[0])*r,Md+.03,-(t-n[1])*r)),o=[],s=Math.max(1,Math.floor(t.length/600));for(let e=0;e<t.length;e+=s)o.push(t[e]);if(o.length>2&&o[0].distanceTo(o[o.length-1])>.01&&o.push(o[0].clone()),o.length<4)return;let c=[0];for(let e=1;e<o.length;e++)c.push(c[e-1]+o[e].distanceTo(o[e-1]));if(c[c.length-1]<.5)return;let l=new na(o,!0,`centripetal`,.5),u=Math.min(800,o.length*2),d=new fo(l,u,.006,4,!0),f=d.attributes.position.count,p=new Float32Array(f),m=u+1;for(let e=0;e<m;e++){let t=e/u;for(let n=0;n<5;n++){let r=e*5+n;r<f&&(p[r]=t)}}d.setAttribute(`aPathFrac`,new lr(p,1));function h(e){return new xo({uniforms:{uHeadPos:{value:0},uTrailLength:{value:e},uOpacity:{value:1}},vertexShader:`
        ...
        `,transparent:!0,blending:2,depthWrite:!1,side:2,toneMapped:!1})}[0,1/3,2/3].forEach(e=>{let t=h(.8),n=new fi(d,t);i.add(n),a.push({mesh:n,material:t,speed:4e-5,offset:e})})}),t.add(i);let c=null;function l(e){c===null&&(c=e);let t=e-c;a.forEach(e=>{let n=(e.offset+t*e.speed)%1;e.material.uniforms.uHeadPos.value=n})}function u(){c=null}return{group:i,update:l,resetTime:u}}function Pd(e){if(e.length===0)return[];let t=new Map,n=e=>`${e[0].toFixed(6)},${e[1].toFixed(6)}`;e.forEach((e,r)=>{let i=n(e[0]),a=n(e[1]);t.has(i)||t.set(i,[]),t.has(a)||t.set(a,[]),t.get(i).push(r),t.get(a).push(r)});let r=new Set,i=[];for(let a=0;a<e.length;a++){if(r.has(a))continue;let o=[],s=e[a][0];o.push(s);let c=a;for(;c!==-1&&!r.has(c);){r.add(c);let i=e[c],a=n(i[0])===n(s)?i[1]:i[0];o.push(a),s=a;let l=n(s),u=t.get(l)||[];c=-1;for(let e of u)if(!r.has(e)){c=e;break}}o.length>3&&i.push(o)}return i.sort((e,t)=>t.length-e.length),i}var Fd=.35;function Id(e,t,n){let{center:r,scale:i}=Od(e),a=new Sn;return e.features.forEach(e=>{let{name:t,centroid:n,center:o}=e.properties;if(!t)return;let s=n||o;if(!s)return;let l=(s[0]-r[0])*i,u=-(s[1]-r[1])*i,d=document.createElement(`canvas`),f=d.getContext(`2d`);d.width=256,d.height=64,f.clearRect(0,0,d.width,d.height),f.shadowColor=`rgba(0, 170, 255, 0.4)`,f.shadowBlur=4,f.fillStyle=`rgba(200, 230, 255, 0.85)`,f.font=`36px "PingFang SC", "Microsoft YaHei", "Helvetica Neue", sans-serif`,f.textAlign=`center`,f.textBaseline=`middle`,f.fillText(t,d.width/2,d.height/2);let p=new Hi(d);p.minFilter=c;let m=new Wr(new Ar({map:p,transparent:!0,opacity:0,depthWrite:!1,depthTest:!1,sizeAttenuation:!0,toneMapped:!1}));m.position.set(l,Fd+.4,u),m.scale.set(1,.25,1),m.renderOrder=999,a.add(m)}),t.add(a),{group:a}}function Ld(e){let t=new Sn,r=new Go().load(`./wenli.jpg`);r.wrapS=n,r.wrapT=n;let i=new uo(50,50),a=new xo({uniforms:{time:{value:0},wenliMap:{value:r}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,transparent:!0,depthWrite:!1,side:2}),o=new fi(i,a);o.rotation.x=-Math.PI/2,o.position.y=-.06,t.add(o),e.add(t);let s=new wr,c=new Float32Array(450);for(let e=0;e<150;e++)c[e*3]=(Math.random()-.5)*20,c[e*3+1]=Math.random()*5,c[e*3+2]=(Math.random()-.5)*20;s.setAttribute(`position`,new lr(c,3));let l=new zi(s,new Pi({color:2254506,size:.025,transparent:!0,opacity:.3,blending:2,depthWrite:!1,sizeAttenuation:!0}));return e.add(l),{update(e){a.uniforms.time.value=e,l.rotation.y=e*5e-5;let t=l.geometry.attributes.position.array;for(let e=0;e<150;e++)t[e*3+1]+=8e-4,t[e*3+1]>5&&(t[e*3+1]=0);l.geometry.attributes.position.needsUpdate=!0}}}function Rd(e,t){let{center:n,scale:r}=Od(e),i=new Sn,a=new Map;e.features.forEach(e=>{let{coordinates:t}=e.geometry;t.forEach(e=>{let t=e[0];if(!(t.length<4))for(let e=0;e<t.length-1;e++){let n=t[e],r=t[e+1],i=`${n[0].toFixed(6)},${n[1].toFixed(6)}|${r[0].toFixed(6)},${r[1].toFixed(6)}`,o=`${r[0].toFixed(6)},${r[1].toFixed(6)}|${n[0].toFixed(6)},${n[1].toFixed(6)}`;a.has(o)?a.set(o,a.get(o)+1):a.has(i)?a.set(i,a.get(i)+1):a.set(i,1)}})});let o=[];a.forEach((e,t)=>{if(e===1){let[e,n]=t.split(`|`),[r,i]=e.split(`,`).map(Number),[a,s]=n.split(`,`).map(Number);o.push([[r,i],[a,s]])}});let s=zd(o),c=[],l=0;s.forEach(e=>{if(e.length<5)return;let t=e.map(([e,t])=>new J((e-n[0])*r,.01,-(t-n[1])*r)),a=t.length,o=new wr().setFromPoints(t),s=new wi({color:35071,transparent:!0,opacity:.4,depthWrite:!1,blending:2,toneMapped:!1,linewidth:1}),u=new Mi(o,s);o.setDrawRange(0,0),i.add(u);let d=new wr().setFromPoints(t),f=new wi({color:4513279,transparent:!0,opacity:1,depthWrite:!1,blending:2,toneMapped:!1}),p=new Mi(d,f);d.setDrawRange(0,0),i.add(p),c.push({glowLine:u,glowGeometry:o,glowMaterial:s,coreLine:p,coreGeometry:d,coreMaterial:f,totalVertices:a,startVertex:l}),l+=a}),t.add(i);let u=l;function d(e){let t=Math.floor(u*e);c.forEach(e=>{let n=e.startVertex+e.totalVertices,r=0;r=t<=e.startVertex?0:t>=n?e.totalVertices:t-e.startVertex,e.glowGeometry.setDrawRange(0,r),e.coreGeometry.setDrawRange(0,r)})}function f(e){c.forEach(t=>{t.glowMaterial.opacity=e*.4,t.coreMaterial.opacity=e})}function p(e){i.visible=e}return d(0),{group:i,update:d,setOpacity:f,setVisible:p}}function zd(e){if(e.length===0)return[];let t=new Map,n=e=>`${e[0].toFixed(6)},${e[1].toFixed(6)}`;e.forEach((e,r)=>{let i=n(e[0]),a=n(e[1]);t.has(i)||t.set(i,[]),t.has(a)||t.set(a,[]),t.get(i).push(r),t.get(a).push(r)});let r=new Set,i=[];for(let a=0;a<e.length;a++){if(r.has(a))continue;let o=[],s=e[a][0];o.push(s);let c=a;for(;c!==-1&&!r.has(c);){r.add(c);let i=e[c],a=n(i[0])===n(s)?i[1]:i[0];o.push(a),s=a;let l=n(s),u=t.get(l)||[];c=-1;for(let e of u)if(!r.has(e)){c=e;break}}o.length>3&&i.push(o)}return i.sort((e,t)=>t.length-e.length),i}function Bd(e,t,n,r){let i=new Sn;e.features.filter(e=>(e.properties.name||``).trim()!==`Guangdong`).forEach(e=>{let{coordinates:r,type:a}=e.geometry;(a===`MultiPolygon`?r:[r]).forEach(e=>{let r=e[0];if(!r||r.length<4)return;let a=r.map(([e,r])=>new J((e-t[0])*n,.015,-(r-t[1])*n)),o=[],s=[];for(let e=0;e<a.length;e++){let t=a[e],n=a[(e+1)%a.length],r=a[(e-1+a.length)%a.length],i=new J().subVectors(n,r).normalize(),c=new J(-i.z,0,i.x).multiplyScalar(.025*.5),l=e*2;if(o.push(t.x-c.x,t.y,t.z-c.z),o.push(t.x+c.x,t.y,t.z+c.z),e<a.length-1){let e=l,t=l+1,n=l+2,r=l+3;s.push(e,n,t),s.push(t,n,r)}}let c=new wr;c.setAttribute(`position`,new fr(o,3)),c.setIndex(s),c.computeVertexNormals();let l=new fi(c,new ei({color:3381708,transparent:!0,opacity:0,depthWrite:!1,blending:2,toneMapped:!1,side:2}));l.userData.lineType=`core`,l.renderOrder=5,i.add(l);let u=[],d=[];for(let e=0;e<a.length;e++){let t=a[e],n=a[(e+1)%a.length],r=a[(e-1+a.length)%a.length],i=new J().subVectors(n,r).normalize(),o=new J(-i.z,0,i.x).multiplyScalar(.06*.5),s=e*2;if(u.push(t.x-o.x,t.y-.001,t.z-o.z),u.push(t.x+o.x,t.y-.001,t.z+o.z),e<a.length-1){let e=s,t=s+1,n=s+2,r=s+3;d.push(e,n,t),d.push(t,n,r)}}let f=new wr;f.setAttribute(`position`,new fr(u,3)),f.setIndex(d),f.computeVertexNormals();let p=new fi(f,new ei({color:1144746,transparent:!0,opacity:0,depthWrite:!1,blending:2,toneMapped:!1,side:2}));p.userData.lineType=`glow`,p.renderOrder=4,i.add(p)})}),i.visible=!1,r.add(i);function a(e){let t=Math.max(0,Math.min(e,1));i.children.forEach(e=>{e.userData.lineType===`core`?e.material.opacity=t*.08:e.material.opacity=t*.03})}function o(e){i.visible=e}return{group:i,setOpacity:a,setVisible:o}}var Vd=document.getElementById(`map-container`),Hd=new An,Ud=new is(45,window.innerWidth/window.innerHeight,.1,1e3),Wd=new J(-.5,5.5,10),Gd=new J(-.2,12,4);Ud.position.copy(Wd),Ud.lookAt(0,0,0);var Kd=new Ku({antialias:!0,alpha:!0,powerPreference:`high-performance`});Kd.setSize(window.innerWidth,window.innerHeight),Kd.setPixelRatio(Math.min(window.devicePixelRatio,2)),Kd.setClearColor(658970,1),Kd.toneMapping=4,Kd.toneMappingExposure=1,Vd.appendChild(Kd.domElement);var qd=new rd(Ud,Kd.domElement);qd.enableDamping=!0,qd.dampingFactor=.08,qd.enablePan=!0,qd.enableZoom=!0,qd.enableRotate=!0,qd.minDistance=3,qd.maxDistance=30,qd.maxPolarAngle=Math.PI/2.1,qd.minPolarAngle=.2,qd.target.set(0,0,0),qd.update(),qd.enabled=!1;var Jd=new wd(Kd);Jd.addPass(new Td(Hd,Ud));var Yd=new Dd(new q(window.innerWidth,window.innerHeight),.7,.5,.85);Jd.addPass(Yd);var Xd=new cs(3359846,.6);Hd.add(Xd);var Zd=new ss(4491468,.8);Zd.position.set(5,10,7),Hd.add(Zd);var Qd={startTime:null,outlineDuration:1200,growDelay:1300,growDuration:2e3,labelDelay:3500,labelDuration:1500,camStart:5100,camEnd:9200,flowLightDelay:9300,flowLightDuration:2e3,neighborStart:.7,cameraAnimDone:!1};function $d(e){if(Qd.cameraAnimDone)return;let t=Qd.camEnd-Qd.camStart;if(e<Qd.camStart){Ud.position.copy(Wd),Ud.lookAt(0,0,0);return}let n=e-Qd.camStart,r=Math.min(n/t,1),i=af(r);Ud.position.x=Wd.x+(Gd.x-Wd.x)*i,Ud.position.y=Wd.y+(Gd.y-Wd.y)*i,Ud.position.z=Wd.z+(Gd.z-Wd.z)*i,Ud.lookAt(0,0,0),qd.target.set(0,0,0),qd.update(),r>=1&&(Qd.cameraAnimDone=!0,Ud.position.copy(Gd),Ud.lookAt(0,0,0),qd.target.set(0,0,0),qd.update(),qd.enabled=!0)}async function ef(){let[e,t]=await Promise.all([fetch(`./guangdong.json`),fetch(`./china_provinces.json`)]),n=await e.json(),r=await t.json(),i=Ld(Hd),{mapGroup:a,outlineGroup:o,topEdges:s,EXTRUDE_DEPTH:c}=jd(n,Hd),l=Nd(n,Hd),u=Id(n,Hd,Ud),d=Rd(n,Hd),{center:f,scale:p}=Od(n),m=Bd(r,f,p,Hd);a.visible=!1,o.visible=!1,s.visible=!1,l.group.visible=!1,u.group.visible=!1,m.setVisible(!1),setTimeout(()=>{Qd.startTime=performance.now()},300);function h(e){if(requestAnimationFrame(h),Qd.startTime!==null){let t=e-Qd.startTime;$d(t),tf(t,a,o,s,l,u,d,m,c,e)}Qd.cameraAnimDone&&qd.update(),i.update(e),Jd.render()}requestAnimationFrame(h)}function tf(e,t,n,r,i,a,o,s,c,l){let u=Math.min(e/Qd.outlineDuration,1),d=u;if(o.update(d),u<1){t.visible=!1,n.visible=!1,r.visible=!1,i.group.visible=!1,a.group.visible=!1,s.setVisible(!1);return}let f=e-Qd.growDelay,p=Math.min(Math.max(f/Qd.growDuration,0),1),m=nf(p);if(p>0){let e=Math.min(p/.6,1);o.setOpacity(1-rf(e))}if(p>.02){t.visible=!0;let e=m;t.children.forEach(t=>{t.scale.y=Math.max(.001,e),t.material[0]&&t.material[0].uniforms&&(t.material[0].uniforms.opacity.value=1),t.material[1]&&t.material[1].uniforms&&(t.material[1].uniforms.opacity.value=1)});let i=rf(Math.min(p/.5,1));n.visible=!0,n.position.y=(c+.01)*m,n.children.forEach(e=>{e.material.opacity=i*.8}),r.visible=!0,r.position.y=(c+.015)*m,r.children.forEach(e=>{e.material.opacity=i*.6})}else t.visible=!1,n.visible=!1,r.visible=!1;if(p>=Qd.neighborStart){s.setVisible(!0);let e=Math.min((p-Qd.neighborStart)/(1-Qd.neighborStart),1);s.setOpacity(nf(e))}else s.setVisible(!1);if(p>=1){n.position.y=c+.01,r.position.y=c+.015;let t=e-Qd.labelDelay,i=Math.max(0,Math.min(t/Qd.labelDuration,1)),o=rf(i);a.group.visible=i>0,a.group.visible&&a.group.children.forEach(e=>{e.material.opacity=o}),s.setVisible(!0),s.setOpacity(1)}else i.group.visible=!1,a.group.visible=!1;let h=e-Qd.flowLightDelay,g=Math.max(0,Math.min(h/Qd.flowLightDuration,1)),_=rf(g);if(i.group.visible=g>0,i.group.visible&&(i.update(l),i.group.children.forEach(e=>{e.material&&e.material.uniforms&&e.material.uniforms.uOpacity&&(e.material.uniforms.uOpacity.value=_)})),e>Qd.flowLightDelay+Qd.flowLightDuration){i.update(l);let e=.65+.15*Math.sin(l*.002);n.children.forEach(t=>{t.material.opacity=e})}}function nf(e){return 1-(1-e)**3}function rf(e){return e<.5?2*e*e:1-(-2*e+2)**2/2}function af(e){return e<.5?4*e*e*e:1-(-2*e+2)**3/2}window.addEventListener(`resize`,()=>{Ud.aspect=window.innerWidth/window.innerHeight,Ud.updateProjectionMatrix(),Kd.setSize(window.innerWidth,window.innerHeight),Jd.setSize(window.innerWidth,window.innerHeight)}),ef();